...
function wpmu_current_site() {
	...
	if ( 1 == count( $sites ) )
		...
		wp_die( /*WP_I18N_NO_SITE_DEFINED*/'本主机未配置站点。若您是本站点的管理员，请访问<a href="http://codex.wordpress.org/Debugging_a_WordPress_Network">调试 WordPress 网络</a>以寻求帮助。'/*/WP_I18N_NO_SITE_DEFINED*/ );
}
...
function ms_not_installed() {
	...
	if ( false && !$wpdb->get_var( "SHOW TABLES LIKE '$wpdb->site'" ) )
		$msg .= '<p>' . sprintf( /*WP_I18N_TABLES_MISSING_LONG*/'<strong>数据表缺失。</strong>有可能是因为 MySQL 未启用、WordPress 未正确安装，或有人删除了 <code>%s</code>。您可能有必要现在进行检查。'/*/WP_I18N_TABLES_MISSING_LONG*/, $wpdb->site ) . '</p>';
	else
	...
	$msg .= /*WP_I18N_RTFM*/'请访问 <a target="_blank" href="http://codex.wordpress.org/Debugging_a_WordPress_Network">bug 报告页面</a>。也许能帮助您找出问题的原因。'/*/WP_I18N_RTFM*/;
	$msg .= ' ' . /*WP_I18N_STUCK*/'若您仍然卡在这一错误消息，请检查数据库中是否含有下列表：'/*/WP_I18N_STUCK*/ . '</p><ul>';
